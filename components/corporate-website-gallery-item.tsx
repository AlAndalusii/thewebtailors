...
export default function CorporateWebsiteGalleryItem() {
  ...
  return (
    ...
    >
      <div className="p-6">
        <h3 className="text-xl text-white font-medium mb-2">Corporate Website Refresh</h3>
        <p className="text-white/60 text-sm mb-4">
          Revitalizing a corporate website with modern design principles, improved user experience, and responsive layouts for all devices.
        </p>
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <div className="relative w-full h-full">
            <Image 
              src="/before 3 .png" 
              alt="Before: Old Corporate Website Design" 
              fill
        ...
        >
          <div className="relative w-full h-full">
            <Image 
              src="/After 3.png" 
              alt="After: Modern Corporate Website Design" 
              fill
              style={{ objectFit: 'contain', objectPosition: 'center' }}
              priority
              quality={100}
