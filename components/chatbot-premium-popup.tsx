      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            {/* Close button - Improved for touch */}
            <button 
              onClick={handleClose}
              className="absolute top-4 right-4 w-10 h-10 rounded-full flex items-center justify-center text-white/70 hover:text-white bg-black/40 hover:bg-white/10 transition-colors z-10 touch-manipulation"
